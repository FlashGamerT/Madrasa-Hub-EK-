...
const kidsActivities = [
  { id: 1, title: 'Alphabets', malayalam: 'അക്ഷരങ്ങൾ', color: '#E0F2F1', icon: <ICONS.Alphabet />, textColor: '#00695C', grid: 'col-span-1' },
  { id: 2, title: 'Rhymes', malayalam: 'പാട്ടുകൾ', color: '#FFF3E0', icon: <ICONS.Rhymes />, textColor: '#EF6C00', grid: 'col-span-1' },
...
const KidsZone: React.FC<KidsZoneProps> = ({ onSelectSlate, onSelectAbout }) => {
  return (
    <div className="grid grid-cols-2 gap-4">
      {kidsActivities.map((act) => (
        <div 
          ...
          onClick={() => {
            if (act.type === 'slate') onSelectSlate?.();
