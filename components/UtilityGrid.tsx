...
const utilities = [
  ...
  { id: 'tra', title: 'Translator', malayalam: 'വിവർത്തനം', icon: <ICONS.Translate />, color: '#FFF8E1', systemId: 'translatedGuide' },
];

const UtilityGrid: React.FC<UtilityGridProps> = ({ selectedClass, onSelect }) => {
